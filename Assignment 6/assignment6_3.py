...
def loadMovieLens(path='/home/ryan/Desktop/CS432/Assignment6/data'):
  # Get movie titles
    movies = {}
...
with open('/home/ryan/Desktop/CS432/Assignment6/data/u.user') as tsv:
    for line in csv.reader(tsv, delimiter="|"):
       p2 = (line[0])
       p1 = '272' 
       prefs = y
       r = sim_pearson(prefs, p1, p2) 
       print(r,',',p2,',',p1,file=open('corrlate.csv','a'))
